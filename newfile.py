...
async def main():
    ...
    email="anayagoel0@gmail.com" # enter email here
    password="111111" # enter password here
    device="423c87d0611f6d8448ddec1ffba050b8cfd4a1ccf99387217022296593616e8d6bc508bfd8a9eb85d2" # enter secret here
    gclink="http://aminoapps.com/p/ul6cg9"  # enter gc link where you are set as host
